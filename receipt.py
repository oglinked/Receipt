""" WollPay Receipt (Version 03.08 of receipt.py program). """
...
while i != 'q':
    ...
    print('Hello Host! \
\nYou run version 03.08 of the program receipt.py.')
    ...
    # Be careful! Getting of current date for current_date 
    # is possible only at the first step of iteration.
